...
KEYBOARD = ReplyKeyboardMarkup([
    ...
    [KeyboardButton("🔔 Alert"), KeyboardButton("⚙️ Setup Alert")],
    [KeyboardButton("🔄 Reset Portfolio"), KeyboardButton("❓ Aiuto")],
...
def phase(dom):
    if dom < 48:
        return "🚨 USCITA", "TOP CICLO! Prendi profitto subito"
    if dom < 52:
...
/reset — Reset prezzi attuali
/addcoin XRP 1000 1.36
/removecoin BTC

🔔 *ALERT*
/alert XRP 3 — Sale a $3
/alert SOL 200 down — Scende a $200
/alerts — Lista alert
/setup — 21 alert strategia

📅 /timeline — Timeline altseason completa
...
━━━━━━━━━━━━━━━━━
📊 BTC Dom: 55-52%
🎯 Cosa fare: TIENI tutto
💡 ETH e SOL iniziano a salire
⚠️ Non vendere ancora!

━━━━━━━━━━━━━━━━━
⚡ *AGOSTO-SETTEMBRE*
━━━━━━━━━━━━━━━━━
📊 BTC Dom <52%
🎯 Cosa fare: Vendi 25% di ogni coin
💡 Altcoin esplodono +300%
✅ Target T1: XRP $3, SOL $200, ETH $4k

━━━━━━━━━━━━━━━━━
🚀 *OTTOBRE-NOVEMBRE*
━━━━━━━━━━━━━━━━━
📊 Fear & Greed >80
🎯 Cosa fare: ESCI dal 50-75%
💡 XRP pump tardivo, DOGE/BONK +1000%
⚠️ Top ciclo IMMINENTE!

━━━━━━━━━━━━━━━━━
📉 *DICEMBRE 2026*
━━━━━━━━━━━━━━━━━
📊 Crollo -60/-80%
🎯 Cosa fare: Accumula BTC
💡 Bear market inizia
✅ Chi è uscito guadagna!
...
async def cmd_reset(update, ctx):
    if init_portfolio():
        ...
        await update.message.reply_text(f"✅ *Portfolio resettato!*\n\n{n} asset con prezzi attuali. P&L parte da 0%.", parse_mode="Markdown", reply_markup=KEYBOARD)
    else:
        await update.message.reply_text("❌ Errore reset", reply_markup=KEYBOARD)
...
async def cmd_setup(update, ctx):
    ...
    DATA["alerts"] = alerts
    save_data(DATA)
    await update.message.reply_text(f"✅ *{len(alerts)} alert impostati!*\n\nXRP, SOL, ETH, BNB, DOGE, HBAR, SEI\n\nUsa /timeline per la roadmap", parse_mode="Markdown", reply_markup=KEYBOARD)
...
async def handle_text(update, ctx):
    ...
    elif t == "📅 Timeline": await cmd_timeline(update, ctx)
...
async def main():
    ...
    log.info("Bot online")
    try:
        await app.bot.send_message(chat_id=CHAT_ID, text="✅ *Bot Online — Versione Finale*\n\n💼 Portfolio caricato\n📅 /timeline per la roadmap\n⚙️ /setup per gli alert\n❓ /help guida", parse_mode="Markdown")
    except: pass
